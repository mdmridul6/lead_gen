                ...
                <form action="{{route('project.create')}}" method="post">
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                <div class="form-group">
                                    <label for="projectName">SKU</label>
                                    <input type="text" name="projectSku" id="projectSku" class="form-control">
                                </div>
                            </div>
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                <div class="form-group">
                                    <label for="projectsDesc">Project Notes</label>
                                    <textarea name="projectsDesc" id="projectsDesc" cols="30" rows="10" class="form-control"></textarea>
                                </div>
                            </div>
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
